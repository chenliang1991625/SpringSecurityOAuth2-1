...
/* * @Description Swagger2 api2 配置
 * @Author wwz
 * @Date 2019/08/05
 * 带权限令牌认证,推荐使用,适合spring security Autho2使用
 */
@Configuration
@EnableSwagger2
...
//                .groupName("spring security OAuth2权限管理API文档")//网关会自动汇总swagger,不用加组名,不然会报错
                .enable(SWAGGER_IS_ENABLE)//是否激活swagger API文档开关
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.itheima.security.distributed.order.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("陈亮", "http://www.baidu.com", "1484157619@qq.com"))
