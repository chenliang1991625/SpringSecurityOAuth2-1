package com.itheima.security.distributed.gateway.config.swaggerConfigs;
...
//                .groupName("spring security OAuth2权限管理API文档")//网关会自动汇总swagger,不用加组名
                .enable(SWAGGER_IS_ENABLE)//是否激活swagger API文档开关
                .apiInfo(apiInfo())
                .select()
//                扫描controller控制器所在包
                .apis(RequestHandlerSelectors.basePackage("com.itheima.security.distributed.gateway.controller"))
